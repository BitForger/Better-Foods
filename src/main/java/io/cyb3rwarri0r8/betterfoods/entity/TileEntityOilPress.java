package io.cyb3rwarri0r8.betterfoods.entity;
/* 
...
import io.cyb3rwarri0r8.betterfoods.blocks.BlockOilPress;
...
public class TileEntityOilPress extends TileEntity implements ISidedInventory
{
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockOilPress.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        else
        {
            ...
            ItemStack itemStack = OilPressRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ItemStack itemstack = OilPressRecipes.smelting().getSmeltingResult(furnaceItemStacks[0]);
