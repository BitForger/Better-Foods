package io.cyb3rwarri0r8.friedchickenbacon.client.container;
 ...
 */
public class ContainerDeepFryer extends Container
{

    private TileEntityDeepFryer tileEntity;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public ContainerDeepFryer(InventoryPlayer invPlayer, TileEntityDeepFryer entityDeepFryer)
    {
        this.tileEntity = entityDeepFryer;
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int par2)
    {
        ...
        if(slot != null && slot.getHasStack())
        {
            ...
            {
                if(DeepFryerRecipes.smelting().getSmeltingResult(itemStack1) != null)
                {
                    if(!this.mergeItemStack(itemStack1,0,1,false)){
                        return null;
                    }
                }
            }else if(TileEntityDeepFryer.isItemFuel(itemStack1))
            {
