package io.cyb3rwarri0r8.friedchickenbacon.tileentity;

import cpw.mods.fml.common.registry.GameRegistry;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;
import io.cyb3rwarri0r8.friedchickenbacon.blocks.BlockDeepFryer;
import io.cyb3rwarri0r8.friedchickenbacon.help.DeepFryerRecipes;
 ...
 */
public class TileEntityOilPress extends TileEntity implements ISidedInventory{
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.furnaceName : "Oil Press";
    }
    ...
    public void readFromNBT(NBTTagCompound tagCompound)
    {
        ...
        if (tagCompound.hasKey("oilPress", 8))
        {
            this.furnaceName = tagCompound.getString("oilPress");
        }
    }
    ...
    public void writeToNBT(NBTTagCompound tagCompound)
    {
        ...
        {
            tagCompound.setString("oilPress", this.furnaceName);
        }
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockDeepFryer.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        else
        {
            ...
            ItemStack itemStack = DeepFryerRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ItemStack itemstack = DeepFryerRecipes.smelting().getSmeltingResult(furnaceItemStacks[0]);
